...
$ebooks = get_ebooks('receitas');
?>
<section class="vz-page-title"><h1>Ebooks de Receitas</h1></section>
  ...
  <article class="vz-ebook">
    ...
    <div class="vz-ebook__body">
      ...
      <div class="vz-ebook__actions">
          ...
          <a href="<?php echo h(BASE_URL . $e["file_path"]); ?>" class="vz-btn" download>Adquirir</a>
        <?php else: ?>
          <?php if ($e["source"] === 'original' && !empty($e["redirect_link"])): ?>
            <a href="<?php echo h($e["redirect_link"]); ?>" class="vz-btn" target="_blank">Adquirir</a>
          <?php else: ?>
            <span class="vz-price"><?php echo h(cents_to_brl((int)$e["price_cents"])); ?></span>
            <button class="vz-fav" data-id="<?php echo (int)$e["id"]; ?>">❤</button>
            <a href='https://go.hotmart.com/B102515237N'><button class="vz-btn">Adquirir</button></a>
          <?php endif; ?>
        <?php endif; ?>
      </div>
    </div>
